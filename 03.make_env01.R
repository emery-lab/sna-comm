...
env01 = env01[, c("plot", "year", "soilmoisture_a_5cm_avg", "soilmoisture_a_5cm_sd", "sm_acf_5cm_24", 
...
sn.avgs = sn.avgs.year[, c("plot", "year", "soilmoisture_a_30cm_avg", ,"soilmoisture_a_5cm_avg", "soilmoisture_b_5cm_avg", "soilmoisture_c_5cm_avg", "soiltemp_30cm_avg", "soiltemp_5cm_avg")]
