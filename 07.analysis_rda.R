...
## Good plots -- just excludes plots that are only  available for two years and 
## also plots that are outliers. ~17~ *cough cough*
...
## make sure column names are the same between both things
## I'm using env1 from another script to do this.
## THIS WILL CAUSE ISSUES IN THE FUTURE
#colnames(env.daily) = colnames(env1)
...
png("/Users/Will/Desktop/FINAL FIGURES-Ecology Paper/fig1a.png", height = 4, width = 4, res = 300, units = "in")
par(mar = c(4,4,1,1), family = "Times New Roman")
rda_pretty_plot(r_mod1)
dev.off()

png("/Users/Will/Desktop/FINAL FIGURES-Ecology Paper/fig1b.png", height = 4, width = 4, res = 300, units = "in")
par(mar = c(4,4,1,1), family = "Times New Roman")
rda_pretty_plot(r_mod2)
dev.off()

png("/Users/Will/Desktop/FINAL FIGURES-Ecology Paper/fig1c.png", height = 4, width = 4, res = 300, units = "in")
par(mar = c(4,4,1,1), family = "Times New Roman")
...
png("/Users/Will/Desktop/fig1_legend_alt.png", height = 8, width = 5, res = 200, units = "in")
plot.new()
...
colnames(env.daily) = c("MSM", "MST", "VST", "VSM", "PSM", "PST")
colnames(env.seaso) = c("MSM", "MST", "VST", "VSM", "PSM", "PST")


png("/Users/Will/Desktop/A1.1.png", height = 8, width = 8, res = 200, units = "in")
chart.Correlation(env.daily, histogram = TRUE, method = "pearson")
dev.off()

png("/Users/Will/Desktop/A1.2.png", height = 8, width = 8, res = 200, units = "in")
